...
🔴 [Blocking issue 1 - Describe the problem + the location of the code]
🔴 [Blocking issue 2 - Describe the problem + the location of the code]
...
💡 [Improvement 1, Non Blocking Issue]
💡 [Improvement 2, Non Blocking Issue]
