...
import CanvasWrapper, { useReducedMotion } from "../common/CanvasWrapper";
  ...
  return (
    <section id="hero" ref={sectionRef} className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        {bio.isDemo && <p className="mt-4 text-xs font-mono text-amber-300">Demo portfolio — sample content and destinations require owner values.</p>}
